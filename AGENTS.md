...
- смысловая часть заголовка PR — на русском;
- описание PR, summary, acceptance criteria/checklist, ограничения и пояснения — на русском;
- review-комментарии, ответы в review threads и обычные комментарии агента в GitHub — на русском;
- если агент создаёт или обновляет issue в рамках задачи, его пользовательский текст также должен быть на русском.

Технические идентификаторы не нужно искусственно переводить: имена файлов, типов, функций, API, commands, названия GitHub Actions checks, code snippets и общепринятые технические термины могут оставаться в исходном виде. В заголовке PR допустим conventional-commit prefix (`feat:`, `fix:`, `docs:` и т.п.), но смысловая часть после prefix должна быть на русском. Commit messages могут оставаться в принятом техническом формате, если issue/spec отдельно не требует русского языка.
